...
library(ggplot2) 
library(dplyr) 
setwd("C:/Users/Ciencias de Datos-2/Downloads/FLACSO-R-2021-main/FLACSO-R-2021-main/Introducción a R/6 Web/6_Datos")
encovid<-data.frame(read.dbf("ECOVID0720.dbf"))
```
